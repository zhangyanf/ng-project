...
(function($) {
    var methods = {
            ...
            if (element.is("form") || element.hasClass("validationEngineContainer")) {
                ...
                if (element.is("form") || element.hasClass("validationEngineContainer")) {
                    ...
                    if (valid && options.onFieldSuccess) {
                        ...
                        if (options.onFieldFailure && options.InvalidFields.length > 0) {
        ...
        hide: function() {
            ...
            $("." + closingtag).fadeTo(fadeDuration, 0.3,
            function() {
                $(this).parent(".formErrorOuter").remove();
                $(this).remove()
            });
        ...
        _onFieldEvent: function(event) {
            ...
            window.setTimeout(function() {
                ...
                if (options.InvalidFields.length == 0 && options.onFieldSuccess) {
                    ...
                    if (options.InvalidFields.length > 0 && options.onFieldFailure) {
                        options.onFieldFailure()
                    }
                }
            },
        ...
        _validateField: function(field, options, skipAjaxValidation) {
            ...
            for (var i = 0,
            field_errors = 0; i < rules.length; i++) {
                ...
                case "required":
                    ...
                    methods._promptFlag = errorMsg;
                    break;
                case "custom":  
                    methods._promptFlag = undefined;
                    if (typeof(methods._promptFlag) !== "undefined") {
                        errorMsg = undefined;
