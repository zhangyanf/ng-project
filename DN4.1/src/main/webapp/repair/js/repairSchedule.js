...
function create_content_schedule(type,form1_id,nav_id,panes_id,schedule_id) {
    ...
    var group_schedule_typ="<div class='form-group' name='group_schedule_type'>" +
        ...
        "<input type='radio' name='select_schedule_type' value='1' checked><span lang='text:periodic_plan'>周期性:</span>"+'&nbsp;&nbsp;&nbsp;'+
        "</label>"+
        "<label class='radio-inline'>"+
        "<input type='radio' name='select_schedule_type' value='2'><span lang='text:according_to_the_deadline'>截至日期型:</span>"+
        "</label>"+
        "</div>"+
        "</div>";
    ...
    var modal_body=""+
        ...
        "<button type='button' class='btn btn-primary' id='submit_"+form1_id+"' onclick='create_update_schedule(\""+type+"\",\""+form1_id+"\")' lang='text:submit'>提交</button>"+
        "</div>"+
        "</div>"+
        "</div>"+
        "</div>";
...
function gerStringForModal(type,form1_id) {
    ...
    var str2="<div class='form-group' style='display: none' name='group_schedule_type_2'>" +
        ...
        "            <span  lang='text:execute_time'></span><span>&nbsp;</span>" +
        "      </label>"+
        "      <div class='col-sm-7 has-feedback'>" +
...
function getString_type_cyclicity_select(month_or_day,type) {
    ...
    if(language == 2){
        var addon= "<div style='width: 45%;' class='input-group'>" +
            ...
            "<input type='text' name='cyclicity_month' class='form-control inputgroup-addon-input validate[required,custom[integer],min[1],max[31]]' style='padding-left:47px;min-width: 135px;'>"+
        ...
        var addon="<div style='width: 210px;' class='input-group'>" +
            ...
            "     <input type='text' name='cyclicity_month' class='form-control inputgroup-addon-input validate[required,custom[integer],min[1],max[31]]' style='padding-right:135px;width: 210px;'>"+
