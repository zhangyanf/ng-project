...
! function(e) {
    ...
    return c.prototype.getId = function() {
        ...
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            ...
            if (t) {
                ...
                l && (r = l)
            } else r = e; if (!r) return void n('Property "' + t + '" is not existed in element ' + e.id);
    ...
    return t.prototype = {
        ...
        _showAxisTrigger: function(e, t, i) {
            ...
            } else p = d.getX(this._event), u = d.getY(this._event), this._styleAxisPointer(l, this.component.grid.getX(), u, this.component.grid.getXend(), u, 0, p, u), i >= 0 ? this._showItemTrigger(!0) : (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._tDom.style.display = "none"); if (h.length > 0) {
    ...
    return t.prototype = {
        ...
        _getZoom: function() {
            ...
            } else n = s instanceof Array ? s : null != s ? [s] : []; if (s = this.zoomOption.yAxisIndex, i && null == s) {
                a = [];
